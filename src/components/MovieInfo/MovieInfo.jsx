                    ...
                    <div tabIndex="-1" {...attrs}>
                        <WrapperMovie>
                            <h3 className="w-full border-b-1 border-[#ebebeb] px-3.5 py-2 text-center text-[0.875rem] leading-[1.1] font-medium">
                                <span className="text-[#c73d3a]">{data.title}</span>
                            </h3>
                            <div className="px-3.5 py-2.5 text-[0.75rem]">
                                <div className="mb-2 text-center text-[#1b2b3a]">{data.original_title}</div>
                                <div>
                                    ...
                                    <div className="my-1 text-[#545454]">
                                        Quốc gia: <span className="text-[#337ab7]">Trung Quốc</span>
                                    </div>
                                    <div className="mb-1 text-[#545454]">
                                        Thể loại: <span className="text-[#337ab7]">Tiên Hiệp</span>
                                    </div>
                                </div>
                            </div>
                        </WrapperMovie>
            ...
            >
                ...
                >
                    ...
                    <div className="bg-blur absolute bottom-0 w-full overflow-hidden px-2.5 pt-2 pb-1">
                        ...
                        <p className="text-text line-clamp-2 overflow-hidden text-ellipsis whitespace-normal">
                            {data.original_title}
                        </p>
                    </div>
