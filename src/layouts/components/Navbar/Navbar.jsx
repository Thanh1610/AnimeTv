...
function Navbar() {
    ...
    const linkStyles = `block min-w-40 px-3.5 py-2 text-left text-[var(--white)] hover:text-[#6cbbff] transition-all duration-500`;
    return (
        <div className="box-shadow h-12 w-full bg-[#12171b]">
            <div className="content flex h-full items-center gap-1.5">
                <Link
                    to={config.routes.home}
                    className="flex h-full items-center text-[0.875rem] text-[#d0d0d0] hover:bg-[var(--black)] hover:text-[#ea8300]"
                >
                ...
                >
                    <div
                        className={clsx(
                            ...
                            'hover:bg-[var(--black)] hover:text-[#ea8300]',
                            openMenu ? 'bg-[var(--black)] text-[#ea8300]' : '',
                        )}
                    >
